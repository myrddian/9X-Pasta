...
public class InputReader {
  ...
  private FettuccineShellHelper shellHelper;

  public InputReader(LineReader lineReader, FettuccineShellHelper shellHelper) {
    this(lineReader, shellHelper, null);
  }

  public InputReader(LineReader lineReader, FettuccineShellHelper shellHelper, Character mask) {
